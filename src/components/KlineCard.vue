...
const auxItems: { key: AuxKey; label: string; desc: string; dotSplit?: [string, string]; color?: string }[] = [
  { key: "structLine", label: "结构线", desc: "红压力/绿支撑（与T线同色）", dotSplit: [cssColor("--up", UP), cssColor("--down", DOWN)] },
  { key: "tradeLine", label: "T线", desc: "浅绿S支撑/浅红B压力", dotSplit: [cssColor("--up", UP), cssColor("--down", DOWN)] },
