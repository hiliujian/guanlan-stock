...
const ICONS: Record<string, { body: string; filled?: boolean }> = {
  ...
  // 持仓（资产组合 / 公文包）：全局统一用于「持仓」语义（替代旧 wallet / 饼图）
  portfolio: {
    body: '<rect x="3" y="7" width="18" height="13" rx="2"/><path d="M8 7V5.5A1.5 1.5 0 0 1 9.5 4h5A1.5 1.5 0 0 1 16 5.5V7"/>',
  },
  // 持仓（激活态）：实心公文包剪影
  "portfolio-filled": {
    body: '<path d="M8 7V5.5A1.5 1.5 0 0 1 9.5 4h5A1.5 1.5 0 0 1 16 5.5V7h2.5A1.5 1.5 0 0 1 20 8.5v10A1.5 1.5 0 0 1 18.5 20h-13A1.5 1.5 0 0 1 4 18.5v-10A1.5 1.5 0 0 1 5.5 7z"/>',
  },
