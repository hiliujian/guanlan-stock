...
const ICONS: Record<string, { body: string; filled?: boolean }> = {
  ...
  // 持仓（资产保管 / 仓位）：保险箱（箱体 + 中央转盘），语义区别于自选「星标」与分组「layers」，
  // 几何为「圆角方 + 同心圆」，缩放不糊；全局统一用于「持仓」
  portfolio: {
    body: '<rect x="3" y="4" width="18" height="16" rx="2.5"/><circle cx="12" cy="12" r="4"/><line x1="12" y1="9.6" x2="12" y2="12"/><line x1="12" y1="12" x2="14" y2="13.2"/>',
  },
  // 持仓（激活态）：实心剪影，evenodd 挖出转盘孔，保证实心后仍可辨认
  "portfolio-filled": {
    body: '<path fill-rule="evenodd" d="M5.5 4h13A2.5 2.5 0 0 1 21 6.5v11a2.5 2.5 0 0 1-2.5 2.5h-13A2.5 2.5 0 0 1 3 17.5v-11A2.5 2.5 0 0 1 5.5 4zm6.5 4a4 4 0 1 0 0 8 4 4 0 0 0 0-8z"/>',
    filled: true,
  },
